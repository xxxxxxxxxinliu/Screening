...
sounds[0].amp(1);
	...
	createCanvas(1440, 4050);

	//shader
    WebglCanvas = createGraphics(1440,4050,WEBGL);
	pixelDensity(1);
	noStroke();

	WebglCanvas2 = createGraphics(1440,4050,WEBGL);
	pixelDensity(1);
	noStroke();
...
//	WebglCanvas2.rect(-width/2,-height/2,width,height)
	WebglCanvas2.rect(-width/2,-height/2,5400,5400)
...
//	image(WebglCanvas2,0,1080,width,height);
	...
	image(maincanvas[0],0,-4320+vx);
	image(maincanvas[1],0,-4320+vx1);
	image(maincanvas[2],0,-4320+vx2);
	image(maincanvas[3],0,-4320+vx3);
	image(maincanvas[4],0,-4320+vx4);
	image(maincanvas[5],0,-4320+vx5);
